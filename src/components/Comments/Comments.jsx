                            ...
                            <div key={item.id}>
                                <div className="comments-block">
                                    <div className="who-is">
                                        <img
                                            ...
                                            src={
                                                item.photoURL
                                                    ? item.photoURL
                                                    : "https://cdn-icons.flaticon.com/png/512/3177/premium/3177440.png?token=exp=1638280238~hmac=1da83835c4daf9914c34947ed0f500ca"
                                            }
                                            alt=""
                                        />
                                        <p className="disp-name" style={{ color: "white" }}>
                                            {item.displayName !== null
                                                ? item.displayName
                                                : item.user}
                                        </p>
                                    </div>
                                    <span className="date-comm" style={{ color: "white" }}>
                                    ...
                                    {bool && checkid === item.id ? (
                                        ...
                                        <p className="comment-text" style={{ color: "white" }}>
                                            {item.text}
                                        </p>
                                    )}
                                    {user ? (
